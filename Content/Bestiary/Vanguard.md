...
**Hit Points:** 10 (1d8 + 2)
**Fort:** +2, **Ref:** -2, **Will:** +2 (+4 vs [[Emotion | Emotion (Fear)]])

___

**Speed:** 5 meters
**Melee:** Longsword ([[Versatile | Versatile (p)]] ): +2 to Hit; 1d8 + 2 Piercing.
**Space:** 2 meters.; **Reach:** 1 meters


___

**Str** +2, **Dex** -2, **Con** +2, **Int** 0, **Wis** +2, **Cha** 0
**Skills:** Athletics +2; Perception +2
**Languages** Common

### Typical Actions
The Vanguard protects the backline valiantly with [[Block]] and [[Attack of Opportunity]].
