...
# Hit Die
Each race has a Hit Die; d4, d6, d8, d10 or d12. The number of Hit Points gained from a race is equal to the highest number on the die, for example a d12 would grant the character 12 Hit Points.
