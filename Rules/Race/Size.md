...
| ------ | ---------- | ------------ | ------ | ------- | ------ | --------- | ------------- | ---------------- |
| Tiny   | 0.3 to 0.6 | 0.5 to 4     | +4     | +4      | +4     | +4        | -8            | -8               |
| Small  | 0.6 to 1.2 | 4 to 32      | +2     | +2      | +2     | +2        | -4            | -4               |
| Medium | 1.2 to 2.4 | 32 to 256    | 0      | 0       | 0      | 0         | 0             | 0                |
| Large  | 2.4 to 4.8 | 256 to 2048  | -2     | -2      | -2     | -2        | +4            | +4               |
| Huge   | 4.8 to 9.6 | 2048 to 4096 | -4     | -4      | -4     | -4        | +8            | +8               |
