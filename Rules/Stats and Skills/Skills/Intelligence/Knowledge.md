...
| Knowledge   | Example                                                                                  |
| ----------- | ---------------------------------------------------------------------------------------- |
| Arcane      | Ancient mysteries; magic traditions; arcane symbols; constructs; dragons; magical beasts |
...
| Task                                                  | Category    |   DC   |
| ----------------------------------------------------- | ----------- |:------:|
| Identify a spell effect that is in place              | Arcane      | 15 + ? | 
| Identify Manufactured hazard                          | Engineering | 15 + ? |
| Identify mineral, stone, or metal                     | Engineering |   15   |
| Determine slope                                       | Engineering |   15   |
| Determine depth underground                           | Engineering |   20   |
| Identify dangerous construction                       | Engineering |   15   |
| Determine a structure’s style or age                  | Engineering |   15   |
| Determine a structure’s weakness                      | Engineering |   20   |
| Identify a creature’s ethnicity or accent             | Geography   |   15   |
...
| Identify natural hazard                               | Nature      | 15 + ? |
