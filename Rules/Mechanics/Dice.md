...
In some cases, such as with the [[Drenched]] Condition, gaining an Effect Die while already having an Effect Die from the same condition, instead increases the Effect Die by an amount of steps based on the new Effect Die. In such cases a d2 is a single step and a d12 is 6 steps.

<br>

> ##### Example
> 1. A Kobold with the [[Drenched | Drenched (d2)]] Condition gains the [[Drenched | Drenched (d6)]] Condition.
> 2. The new condition has a d6 Effect Die, increasing the Kobolds [[Drenched]] Condition by 2 steps.
> 3. The Kobolds new [[Drenched]] Condition now has a d8 Effect Die.

<br>

An Effect Die can never increase over a d12, and if an Effect Die would ever be reduced to below a d2, the effect or condition that gave said die is removed.
